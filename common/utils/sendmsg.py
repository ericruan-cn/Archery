...
class MsgSender(object):
    ...
    def send_email(self, subject, body, to, **kwargs):
        ...
        try:
            ...
            #if self.MAIL_SSL:
            #    server = smtplib.SMTP_SSL(self.MAIL_REVIEW_SMTP_SERVER, self.MAIL_REVIEW_SMTP_PORT, timeout=3)  # 默认SSL端口是465
            #else:
            #    server = smtplib.SMTP(self.MAIL_REVIEW_SMTP_SERVER, self.MAIL_REVIEW_SMTP_PORT, timeout=3)  # 默认端口是25
